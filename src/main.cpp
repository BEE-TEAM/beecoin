...
unsigned int nRetarget = 70;
unsigned int nStakeMinAge = 6 * 60 * 60; // 6 hour
unsigned int nStakeMaxAge = 30 * 24 * 60 * 60;           //30day
...
const string strMessageMagic = "BEEcoin Signed Message:\n";
...
bool CheckDiskSpace(uint64_t nAdditionalBytes)
{
    ...
    if (nFreeBytesAvailable < nMinDiskSpace + nAdditionalBytes)
    {
        ...
        printf("*** %s\n", strMessage.c_str());
        uiInterface.ThreadSafeMessageBox(strMessage, "BEEcoin", CClientUIInterface::OK | CClientUIInterface::ICON_EXCLAMATION | CClientUIInterface::MODAL);
        StartShutdown();
        return false;
    }
    return true;
...
bool LoadBlockIndex(bool fAllowNew)
{
    ...
    if (mapBlockIndex.empty())
    {
        ...
        const char* pszTimestamp = "BEEcoin No one know the bees hard";
        CTransaction txNew;
        txNew.nTime = 1400000000;
        txNew.vin.resize(1);
        txNew.vout.resize(1);
        ...
        //// debug print
        assert(block.hashMerkleRoot == uint256("0x5186742e1fee1e57158a9be701a200c1398af9d99c8e4a4d0e56f455e549e855"));
        block.print();
