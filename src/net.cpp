...
void ThreadMapPort2(void* parg)
{
    ...
    if (r == 1)
    {
        ...
        string strDesc = "BEEcoin " + FormatFullVersion();
#ifndef UPNPDISCOVER_SUCCESS
        /* miniupnpc 1.5 */
...
static const char *strDNSSeed[][2] = {
    {"seed1.cloudalt.info", "seed1.cloudalt.info"},
	{"seed2.cloudalt.info", "seed2.cloudalt.info"},
	{"seed3.cloudalt.info", "seed3.cloudalt.info"},
	{"seed4.cloudalt.info", "seed4.cloudalt.info"},
};

void ThreadDNSAddressSeed(void* parg)
{
    // Make this thread recognisable as the DNS seeding thread
    RenameThread("BEEcoin-dnsseed");
...
bool BindListenPort(const CService &addrBind, string& strError)
{
    ...
    if (::bind(hListenSocket, (struct sockaddr*)&sockaddr, len) == SOCKET_ERROR)
    {
        ...
        if (nErr == WSAEADDRINUSE)
            strError = strprintf(_("Unable to bind to %s on this computer. BEEcoin is probably already running."), addrBind.ToString().c_str());
        else
